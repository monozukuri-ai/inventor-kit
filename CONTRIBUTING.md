...
Read the [development guide](docs/development.md) and [supported scope](docs/support.md).
Keep changes bounded, preserve source values and include evidence for newly
supported file profiles. Update English and Japanese public documentation
together. Do not submit confidential CAD files or samples without redistribution
permission.

## Contribution licensing

inventor-kit offers new material under PolyForm Noncommercial 1.0.0 and separate
...
> I accept the inventor-kit Contributor License Agreement version 1.0 at
